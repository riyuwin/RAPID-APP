...
function FormModal() {
    ...
    const handleSubmit = (event) => {
        ...
        if (actionParameter === "Add") {
            ...
            /* alert("Edit"); */
            console.log(editPatientID, 'asfasf')
            handleEditPatientCareReport(editPatientID, accountId, ambulance.ambulanceId);
        }
    };
    ...
    const handleDeletePatient = (patientId) => {
        DeletePatientCareReport("PatientCareReport", patientId);
    };
